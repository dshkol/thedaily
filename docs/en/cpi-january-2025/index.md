---
title: Consumer prices up 1.9% year over year in January 2025
verification_json: output/data_18_10_0004_enhanced.json
toc: false
---
# Consumer prices up 1.9% year over year in January 2025

<p class="release-date">Released: February 18, 2025</p>

<div class="highlights">

- The Consumer Price Index rose 1.9% year over year in January 2025
- Inflation was unchanged from December's 1.8%
- Food prices increased 3.8% year over year
- Shelter costs rose 4.5%

</div>

The Consumer Price Index (CPI) rose 1.9% in January 2025 compared with the same month a year earlier, up slightly from 1.8% in December. Inflation remained below the Bank of Canada's 2% target for the third consecutive month.

On a monthly basis, prices increased 0.1% from December 2024.

## Year-over-year inflation trend

Annual inflation has stabilized near the Bank of Canada's 2% target, following a sustained decline from the 2022 peak.
...
Shelter remained the largest contributor to annual inflation at 4.5%, followed by food at 3.8%. Transportation prices declined 0.3%.

```js
const components = [
  {name: "Shelter", change: 4.5},
...
| Indicator | January 2025 | Change from December | Change from January 2024 |
|-----------|----------:|------------------:|---------------------:|
| All-items CPI (YoY) | +1.9% | +0.1 pp | -1.0 pp |
| Food | +3.8% | — | — |
| Shelter | +4.5% | — | — |
| Transportation | -0.3% | — | — |
...
current <- national_cpi %>% filter(REF_DATE == "2025-01") %>% pull(VALUE)
previous <- national_cpi %>% filter(REF_DATE == "2024-01") %>% pull(VALUE)
...
display(createSidebar(articles, "cpi-january-2025", "en"));
```
