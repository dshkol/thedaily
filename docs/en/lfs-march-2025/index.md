...
- Employment decreased by 33,000 (-0.2%) in March 2025
- The unemployment rate rose 0.1 percentage points to 6.7%
- Total employment rose 347,000 (+1.7%) compared with March 2024
- Full-time employment led the decline, down 50,000 from February

</div>

Employment fell by 33,000 (-0.2%) in March 2025, reversing gains seen in January and February. The unemployment rate rose 0.1 percentage points to 6.7%, reflecting the employment decline.

Total employment stood at 21.0 million in March 2025, an increase of 347,000 (+1.7%) compared with March 2024.
...
display(Plot.plot({
  title: "Unemployment rate, January 2023 to March 2025",
  width: 680,
  height: 300,
...
display(Plot.plot({
  title: "Employment (thousands), January 2023 to March 2025",
  width: 680,
  height: 300,
...
| Indicator | March 2025 | February 2025 | March 2024 | Monthly change | Year-over-year change |
|-----------|---------------|--------------|---------------|----------------|----------------------|
| Employment (thousands) | 20,962.0 | 20,995.0 | 20,615.0 | -33.0 | +347.0 |
| Unemployment rate | 6.7% | 6.6% | 6.1% | +0.1 pp | +0.6 pp |
| Participation rate | 65.2% | 65.4% | 65.0% | -0.2 pp | +0.2 pp |
| Employment rate | 60.9% | 61.1% | 61.1% | -0.2 pp | -0.2 pp |

## Full-time and part-time employment

Full-time employment decreased by 50,000 (-0.5%) in March. Part-time employment rose 30,000.

```js
const typeData = [
  {type: "Full-time employment", change: -49.7, yoy: 1.4},
  {type: "Part-time employment", change: 29.5, yoy: 2.5}
];
...
display(Plot.plot({
  ...
  marginLeft: 150,
  marginRight: 50,
  x: {domain: [-60, 30], grid: true, label: "Change (thousands)"},
  y: {label: null},
  marks: [
    Plot.ruleX([0]),
    Plot.barX(typeData, {
...
display(createSidebar(articles, "lfs-march-2025", "en"));
```
