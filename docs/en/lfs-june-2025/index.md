...
- Employment increased by 83,000 (+0.4%) in June 2025
- The unemployment rate fell 0.1 percentage points to 6.9%
- Total employment rose 345,000 (+1.7%) compared with June 2024
- Part-time employment led gains, up 70,000 from May

</div>

Employment rose by 83,000 (+0.4%) in June 2025, rebounding from a gain of 9,000 in May. The unemployment rate fell 0.1 percentage points to 6.9%, down from 7.0% in the previous month.

Total employment stood at 21.1 million in June 2025, an increase of 345,000 (+1.7%) compared with June 2024.
...
display(Plot.plot({
  title: "Unemployment rate, January 2023 to June 2025",
  width: 680,
  height: 300,
...
display(Plot.plot({
  title: "Employment (thousands), January 2023 to June 2025",
  width: 680,
  height: 300,
...
| Indicator | June 2025 | May 2025 | June 2024 | Monthly change | Year-over-year change |
|-----------|---------------|--------------|---------------|----------------|----------------------|
| Employment (thousands) | 21,061.0 | 20,978.0 | 20,716.0 | +83.0 | +345.0 |
| Unemployment rate | 6.9% | 7.0% | 6.4% | -0.1 pp | +0.5 pp |
| Participation rate | 65.4% | 65.3% | 65.1% | +0.1 pp | +0.3 pp |
| Employment rate | 60.9% | 60.8% | 60.9% | +0.1 pp | 0.0 pp |

## Full-time and part-time employment

Part-time employment increased by 70,000 (+1.8%) in June. Full-time employment rose 9,000.

```js
const typeData = [
  {type: "Full-time employment", change: 9.1, yoy: 1.5},
  {type: "Part-time employment", change: 69.5, yoy: 2.2}
];
...
display(createSidebar(articles, "lfs-june-2025", "en"));
```
