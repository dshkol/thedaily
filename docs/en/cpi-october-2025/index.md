---
title: Consumer prices up 2.2% year over year in October 2025
---

# Consumer prices up 2.2% year over year in October 2025

<p class="release-date">Released: 2025-12-25</p>

<div class="metric-box">
  <div class="value">+2.2%</div>
  <div class="label">Year-over-year change in Consumer Price Index, October 2025</div>
</div>

The Consumer Price Index (CPI) rose 2.2% in October 2025 compared with the same month a year earlier. The index stood at 165.3, up from 161.8 in November 2024. On a monthly basis, prices increased 0.2% from October 2025.
...
current <- national_cpi %>% filter(REF_DATE == "2025-10") %>% pull(VALUE)
previous <- national_cpi %>% filter(REF_DATE == "2024-10") %>% pull(VALUE)
...
display(createSidebar(articles, "cpi-october-2025", "en"));
```
