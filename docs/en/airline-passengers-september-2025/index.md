...
- Major Canadian airlines carried 7.2 million passengers in September 2025, down 11.3% from August
- Year-over-year, passenger volumes rose an estimated 2.5% compared with September 2024
- The decline from August reflects the end of the peak summer travel season
- Load factor remained strong at 82.8%

</div>

Major Canadian airlines carried 7.2 million passengers in September 2025, down 11.3% from August's 8.1 million. The monthly decline is typical as summer vacation travel winds down and schools resume across the country.

Compared with September 2024, passenger volumes increased an estimated 2.5%, continuing the year-over-year recovery trend observed throughout 2025.
...
display(Plot.plot({
  title: "Airline passengers, October 2023 to September 2025 (millions)",
  width: 680,
  height: 300,
...
Air travel volumes in 2025 peaked in July at 8.3 million passengers before declining through the fall months.
...
display(Plot.plot({
  ...
  y: {grid: true, label: "Percent change", domain: [-15, 18]},
  marks: [
    Plot.ruleY([0]),
    Plot.barY(momData, {
      x: "month",
...
|-----------|---------------:|-------------------:|---------------------------:|
| Passengers (millions) | 7.22 | -11.3% | +2.5% |
