...
current <- national_cpi %>% filter(REF_DATE == "2025-03") %>% pull(VALUE)
previous <- national_cpi %>% filter(REF_DATE == "2024-03") %>% pull(VALUE)
...
display(createSidebar(articles, "cpi-march-2025", "en"));
```
