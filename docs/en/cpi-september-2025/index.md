---
title: Consumer prices up 2.4% year over year in September 2025
---

# Consumer prices up 2.4% year over year in September 2025

<p class="release-date">Released: 2025-12-25</p>

<div class="metric-box">
  <div class="value">+2.4%</div>
  <div class="label">Year-over-year change in Consumer Price Index, September 2025</div>
</div>

The Consumer Price Index (CPI) rose 2.4% in September 2025 compared with the same month a year earlier. The index stood at 164.9, up from 161.8 in November 2024. On a monthly basis, prices increased 0.1% from October 2025.

<div class="highlights">

**Highlights**

- The Consumer Price Index rose 2.4% year over year in September 2025
- Food costs increased 4.2%, the largest contributor to inflation
- Household operations, furnishings and equipment prices rose 3.3% compared to September last year
...
current <- national_cpi %>% filter(REF_DATE == "2025-09") %>% pull(VALUE)
previous <- national_cpi %>% filter(REF_DATE == "2024-09") %>% pull(VALUE)
...
display(createSidebar(articles, "cpi-september-2025", "en"));
```
