---
title: L'emploi en baisse de 41 000 en juillet 2025, le taux de chômage inchangé à 6,9 %
verification_json: output/data_14_10_0287_enhanced.json
toc: false
---

# L'emploi en baisse de 41 000 en juillet 2025, le taux de chômage inchangé à 6,9 %

<p class="release-date">Diffusion : 8 août 2025</p>

<div class="highlights">

- L'emploi a diminué de 41 000 (-0,2 %) en juillet 2025
- Le taux de chômage est demeuré inchangé à 6,9 %
- L'emploi total a augmenté de 307 000 (+1,5 %) par rapport à juillet 2024
- L'emploi à temps plein a diminué de 46 000 par rapport à juin

</div>

L'emploi a diminué de 41 000 (-0,2 %) en juillet 2025, après un gain de 83 000 en juin. Le taux de chômage est demeuré inchangé à 6,9 %, une baisse du taux d'activité ayant compensé les pertes d'emploi.

L'emploi total s'est établi à 21,0 millions en juillet 2025, soit une hausse de 307 000 (+1,5 %) par rapport à juillet 2024.
...
display(Plot.plot({
  title: "Taux de chômage, janvier 2023 à juillet 2025",
  width: 680,
  height: 300,
...
display(Plot.plot({
  title: "Emploi (en milliers), janvier 2023 à juillet 2025",
  width: 680,
  height: 300,
...
| Indicateur | Juillet 2025 | Juin 2025 | Juillet 2024 | Variation mensuelle | Variation annuelle |
|-----------|---------------|--------------|---------------|----------------|----------------------|
| Emploi (en milliers) | 21 020,0 | 21 061,0 | 20 713,0 | -41,0 | +307,0 |
| Taux de chômage | 6,9 % | 6,9 % | 6,4 % | 0,0 pp | +0,5 pp |
| Taux d'activité | 65,1 % | 65,4 % | 65,0 % | -0,3 pp | +0,1 pp |
| Taux d'emploi | 60,7 % | 60,9 % | 60,9 % | -0,2 pp | -0,2 pp |

## Emploi à temps plein et à temps partiel

L'emploi à temps plein a diminué de 46 000 (-0,3 %) en juillet. L'emploi à temps partiel a augmenté de 10 000.

```js
const typeData = [
  {type: "Emploi à temps plein", change: -45.9, yoy: 1.4},
  {type: "Emploi à temps partiel", change: 10.3, yoy: 2.0}
];
...
display(Plot.plot({
  ...
  marginLeft: 150,
  marginRight: 50,
  x: {domain: [-60, 20], grid: true, label: "Variation (en milliers)"},
  y: {label: null},
  marks: [
    Plot.ruleX([0]),
    Plot.barX(typeData, {
...
Cet article de rattrapage couvre les données de juillet 2025, publié dans le cadre de l'initiative de couverture historique du D-AI-LY.
...
display(createSidebar(articles, "epa-juillet-2025", "fr"));
```
