---
title: Les prix à la consommation en hausse de 1,7 % d'une année à l'autre en avril 2025
verification_json: output/data_18_10_0004_enhanced.json
toc: false
---

# Les prix à la consommation en hausse de 1,7 % d'une année à l'autre en avril 2025

<p class="release-date">Diffusion : 20 mai 2025</p>

<div class="highlights">

- L'Indice des prix à la consommation a augmenté de 1,7 % d'une année à l'autre en avril 2025
- L'inflation a ralenti par rapport au taux de 2,3 % de mars
- Les prix des aliments ont augmenté de 3,6 % d'une année à l'autre
- Les coûts du logement ont augmenté de 4,4 %

</div>

L'Indice des prix à la consommation (IPC) a augmenté de 1,7 % en avril 2025 par rapport au même mois un an plus tôt, en baisse par rapport au taux de 2,3 % de mars. Il s'agit du taux d'inflation le plus bas depuis mars 2021, alors que les prix de l'énergie ont continué de se modérer.

Sur une base mensuelle, les prix ont augmenté de 0,4 % par rapport à mars 2025.
...
Le logement est demeuré le principal contributeur à l'inflation annuelle à 4,4 %, suivi des aliments à 3,6 %. Les prix des transports ont diminué de 0,6 % en raison de la baisse des coûts de l'essence.
...
| Indicateur | Avril 2025 | Variation par rapport à mars | Variation par rapport à avril 2024 |
|-----------|----------:|-----------------------------:|---------------------------------:|
| IPC d'ensemble (a/a) | +1,7 % | -0,6 pp | -1,0 pp |
| Aliments | +3,6 % | — | — |
| Logement | +4,4 % | — | — |
| Transports | -0,6 % | — | — |
...
display(createSidebar(articles, "ipc-avril-2025", "fr"));
```
