---
title: Les ventes au détail augmentent de 0,3 % en avril, Terre-Neuve-et-Labrador en tête des gains d'une année à l'autre
toc: false
---

# Les ventes au détail augmentent de 0,3 % en avril, Terre-Neuve-et-Labrador en tête des gains d'une année à l'autre
...
- Les ventes au détail ont augmenté de 0,3 % en avril 2025 pour s'établir à 70,0 milliards de dollars, après une hausse de 0,9 % en mars
- D'une année à l'autre, les ventes étaient en hausse de 4,8 %, Terre-Neuve-et-Labrador (+6,8 %) en tête des gains provinciaux
- Dix des onze administrations ont enregistré une croissance positive d'une année à l'autre
- Le Yukon était la seule administration à afficher une baisse d'une année à l'autre (-1,4 %)

</div>

Les ventes au détail au Canada ont augmenté de 0,3 % en avril 2025 pour s'établir à 70,0 milliards de dollars, s'appuyant sur le gain de 0,9 % enregistré en mars. D'une année à l'autre, les ventes étaient supérieures de 4,8 % à celles d'avril 2024.

La hausse d'avril a prolongé une séquence de deux mois de gains. Dix des onze provinces et territoires ont enregistré une croissance positive d'une année à l'autre, Terre-Neuve-et-Labrador en tête des gains.
...
display(Plot.plot({
  title: "Ventes au détail, Canada, janvier 2024 à avril 2025 (milliards de $)",
  width: 680,
  height: 300,
...
Terre-Neuve-et-Labrador a mené la croissance des ventes d'une année à l'autre à 6,8 %, suivie de la Colombie-Britannique à 6,6 %. L'Ontario a affiché le troisième gain le plus élevé à 5,9 %.

Le Yukon était la seule administration à enregistrer une baisse d'une année à l'autre, soit -1,4 %. L'Île-du-Prince-Édouard a affiché le plus petit gain parmi les provinces à 0,9 %.
...
const provincialData = [
  ...
  {province: "Nouvelle-Écosse", value: 3.8},
  {province: "Québec", value: 3.4},
...
display(Plot.plot({
  title: "Variation d'une année à l'autre des ventes au détail selon la province, avril 2025 (%)",
  width: 680,
  height: 340,
  marginLeft: 180,
  x: {grid: true, label: "Variation d'une année à l'autre (%)", domain: [-3, 9]},
...
Les concessionnaires de véhicules automobiles et de pièces sont demeurés le plus important sous-secteur du commerce de détail en avril, avec des ventes de 19,4 milliards de dollars. Les détaillants en alimentation et en boissons ont enregistré des ventes de 13,3 milliards de dollars.

| Sous-secteur du commerce de détail | Ventes (avril 2025) |
|---|---:|
| Concessionnaires de véhicules automobiles et de pièces | 19,4 G$ |
...
display(createSidebar(articles, "commerce-detail-avril-2025", "fr"));
```
