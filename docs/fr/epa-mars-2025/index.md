---
title: L'emploi en baisse de 33 000 en mars 2025, le taux de chômage monte à 6,7 %
verification_json: output/data_14_10_0287_enhanced.json
toc: false
---

# L'emploi en baisse de 33 000 en mars 2025, le taux de chômage monte à 6,7 %

<p class="release-date">Diffusion : 4 avril 2025</p>

<div class="highlights">

- L'emploi a diminué de 33 000 (-0,2 %) en mars 2025
- Le taux de chômage a augmenté de 0,1 point de pourcentage pour s'établir à 6,7 %
- L'emploi total a augmenté de 347 000 (+1,7 %) par rapport à mars 2024
- L'emploi à temps plein a mené le repli, en baisse de 50 000 par rapport à février

</div>

L'emploi a diminué de 33 000 (-0,2 %) en mars 2025, effaçant les gains observés en janvier et février. Le taux de chômage a augmenté de 0,1 point de pourcentage pour s'établir à 6,7 %, reflétant la baisse de l'emploi.

L'emploi total s'est établi à 21,0 millions en mars 2025, soit une hausse de 347 000 (+1,7 %) par rapport à mars 2024.
...
display(Plot.plot({
  title: "Taux de chômage, janvier 2023 à mars 2025",
  width: 680,
  height: 300,
...
display(Plot.plot({
  title: "Emploi (en milliers), janvier 2023 à mars 2025",
  width: 680,
  height: 300,
...
| Indicateur | Mars 2025 | Février 2025 | Mars 2024 | Variation mensuelle | Variation annuelle |
|-----------|---------------|--------------|---------------|----------------|----------------------|
| Emploi (en milliers) | 20 962,0 | 20 995,0 | 20 615,0 | -33,0 | +347,0 |
| Taux de chômage | 6,7 % | 6,6 % | 6,1 % | +0,1 pp | +0,6 pp |
| Taux d'activité | 65,2 % | 65,4 % | 65,0 % | -0,2 pp | +0,2 pp |
| Taux d'emploi | 60,9 % | 61,1 % | 61,1 % | -0,2 pp | -0,2 pp |

## Emploi à temps plein et à temps partiel

L'emploi à temps plein a diminué de 50 000 (-0,5 %) en mars. L'emploi à temps partiel a augmenté de 30 000.

```js
const typeData = [
  {type: "Emploi à temps plein", change: -49.7, yoy: 1.4},
  {type: "Emploi à temps partiel", change: 29.5, yoy: 2.5}
];
...
display(Plot.plot({
  ...
  marginLeft: 150,
  marginRight: 50,
  x: {domain: [-60, 30], grid: true, label: "Variation (en milliers)"},
  y: {label: null},
  marks: [
    Plot.ruleX([0]),
    Plot.barX(typeData, {
...
display(createSidebar(articles, "epa-mars-2025", "fr"));
```
