---
title: L'emploi en hausse de 67 000 en octobre 2025, le taux de chômage recule à 6,9 %
toc: false
---

# L'emploi en hausse de 67 000 en octobre 2025, le taux de chômage recule à 6,9 %

<p class="release-date">Diffusion : 7 novembre 2025</p>

<div class="highlights">

- L'emploi a augmenté de 67 000 (+0,3 %) en octobre 2025
- Le taux de chômage a diminué de 0,2 point de pourcentage pour s'établir à 6,9 %
- L'emploi total a augmenté de 299 000 (+1,4 %) par rapport à octobre 2024
- L'emploi à temps partiel a mené les gains, en hausse de 85 000 par rapport à septembre

</div>

L'emploi a augmenté de 67 000 (+0,3 %) en octobre 2025, après un gain de 60 000 en septembre. Le taux de chômage a diminué de 0,2 point de pourcentage pour s'établir à 6,9 %, en baisse par rapport à 7,1 % le mois précédent.

L'emploi total s'est établi à 21,1 millions en octobre 2025, soit une hausse de 299 000 (+1,4 %) par rapport à octobre 2024.
...
display(Plot.plot({
  title: "Taux de chômage, janvier 2023 à octobre 2025",
  width: 680,
  height: 300,
...
display(Plot.plot({
  title: "Emploi (en milliers), janvier 2023 à octobre 2025",
  width: 680,
  height: 300,
...
|-----------|---------------|--------------|---------------|----------------|----------------------|
| Emploi (en milliers) | 21 081,9 | 21 014,9 | 20 783,0 | +67,0 | +298,9 |
| Taux de chômage | 6,9 % | 7,1 % | 6,6 % | -0,2 pp | +0,3 pp |
| Taux d'activité | 65,3 % | 65,2 % | 65,1 % | +0,1 pp | +0,2 pp |
| Taux d'emploi | 60,8 % | 60,6 % | 60,8 % | +0,2 pp | 0,0 pp |

## Emploi à temps plein et à temps partiel

L'emploi à temps partiel a augmenté de 85 000 (+2,2 %) en octobre. L'emploi à temps plein a diminué de 45 000.

```js
const typeData = [
  {type: "Emploi à temps plein", change: -45.4, yoy: 1.2},
  {type: "Emploi à temps partiel", change: 85.1, yoy: 2.3}
];
...
display(Plot.plot({
  ...
  marginLeft: 150,
  marginRight: 50,
  x: {domain: [-60, 100], grid: true, label: "Variation (en milliers)"},
  y: {label: null},
  marks: [
    Plot.ruleX([0]),
    Plot.barX(typeData, {
...
Cet article de rattrapage couvre les données d'octobre 2025, publié dans le cadre de l'initiative de couverture historique du D-AI-LY.
...
display(createSidebar(articles, "epa-octobre-2025", "fr"));
```
