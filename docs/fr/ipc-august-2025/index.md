---
title: Les prix à la consommation en hausse de 1.9 % d'une année à l'autre en août 2025
---

# Les prix à la consommation en hausse de 1.9 % d'une année à l'autre en août 2025

<p class="release-date">Released: 2025-12-25</p>

<div class="metric-box">
  <div class="value">+1.9%</div>
  <div class="label">Variation d'une année à l'autre de l'Indice des prix à la consommation, août 2025</div>
</div>

L'Indice des prix à la consommation (IPC) a augmenté de 1.9 % en août 2025 par rapport au même mois un an plus tôt. L'indice s'établissait à 164.8, en hausse par rapport à 161.8 en novembre 2024. Sur une base mensuelle, les prix ont diminué de 0.1 % par rapport à octobre 2025.

<div class="highlights">

**Faits saillants**

- L'Indice des prix à la consommation a augmenté de 1.9 % d'une année à l'autre en août 2025
- Les coûts du food ont augmenté de 4.2 %, la plus forte hausse
- Les prix des household operations, furnishings and equipment ont augmenté de 3.3 % par rapport à août l'an dernier
...
display(createSidebar(articles, "ipc-august-2025", "fr"));
```
