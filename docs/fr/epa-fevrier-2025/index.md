...
# L'emploi en légère hausse de 2 000 en février 2025, le taux de chômage inchangé à 6,6 %

<p class="release-date">Diffusion : 7 mars 2025</p>

<div class="highlights">

- L'emploi a peu varié, en hausse de 2 000 (+0,0 %) en février 2025
- Le taux de chômage est demeuré stable à 6,6 %
- L'emploi total a augmenté de 387 000 (+1,9 %) par rapport à février 2024
- Le taux d'activité a diminué de 0,1 point de pourcentage pour s'établir à 65,4 %

</div>

L'emploi a été essentiellement inchangé en février 2025, en légère hausse de 2 000 (+0,0 %) après un gain de 76 000 en janvier. Le taux de chômage est demeuré stable à 6,6 %, la croissance de la population active ayant été égale aux gains d'emploi.

L'emploi total s'est établi à 21,0 millions en février 2025, soit une hausse de 387 000 (+1,9 %) par rapport à février 2024.
...
display(Plot.plot({
  title: "Taux de chômage, janvier 2023 à février 2025",
  width: 680,
  height: 300,
...
display(Plot.plot({
  title: "Emploi (en milliers), janvier 2023 à février 2025",
  width: 680,
  height: 300,
...
| Indicateur | Février 2025 | Janvier 2025 | Février 2024 | Variation mensuelle | Variation annuelle |
|-----------|---------------|--------------|---------------|----------------|----------------------|
| Emploi (en milliers) | 20 995,0 | 20 993,0 | 20 608,0 | +2,0 | +387,0 |
| Taux de chômage | 6,6 % | 6,6 % | 5,9 % | 0,0 pp | +0,7 pp |
| Taux d'activité | 65,4 % | 65,5 % | 65,2 % | -0,1 pp | +0,2 pp |
| Taux d'emploi | 61,1 % | 61,1 % | 61,4 % | 0,0 pp | -0,3 pp |

## Emploi à temps plein et à temps partiel

L'emploi à temps plein a diminué de 21 000 (-0,1 %) en février. L'emploi à temps partiel a augmenté de 21 000.

```js
const typeData = [
  {type: "Emploi à temps plein", change: -21.4, yoy: 1.6},
  {type: "Emploi à temps partiel", change: 20.8, yoy: 2.8}
];
...
display(Plot.plot({
  ...
  marginLeft: 150,
  marginRight: 50,
  x: {domain: [-30, 30], grid: true, label: "Variation (en milliers)"},
  y: {label: null},
  marks: [
    Plot.ruleX([0]),
    Plot.barX(typeData, {
...
display(createSidebar(articles, "epa-fevrier-2025", "fr"));
```
